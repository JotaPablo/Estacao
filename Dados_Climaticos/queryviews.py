...
@extend_schema(
    description="Retorna o último dado climático enviado por um dispositivo.",
    parameters=[
        OpenApiParameter(
            name='identificador',
            type=OpenApiTypes.STR,
            location=OpenApiParameter.PATH,
            description='UUID ou ID do dispositivo'
        )
    ],
    responses={
    ...
    examples=[
        ...
        OpenApiExample(
            ...
            value={"erro": "Nenhum dado encontrado."},
            status_codes=['404'],
            response_only=True
        ),
        OpenApiExample(
            ...
            value={
                "id": 1,
                "dispositivo": 1,
                "time": "2025-03-31T07:54:57-03:00",
                "temperatura": 30.2,
                "umidade": 0.8,
                "precipitacao": 0.2,
...
@extend_schema(
    description="Calcula a média de um campo climático em intervalos de tempo para um dispositivo.",
    parameters=[
        OpenApiParameter(
            name='identificador',
            type=OpenApiTypes.STR,
        ...
        OpenApiParameter(
            ...
            required=True,
            description='Data/hora de início (ex: 2025-03-31T07:54:57)'
        ),
        OpenApiParameter(
            name='fim',
            type=OpenApiTypes.DATETIME,
            location=OpenApiParameter.QUERY,
            required=True,
            description='Data/hora de fim (ex: 2025-04-01T07:54:57)'
        ),
        OpenApiParameter(
            name='tipo',
            type=OpenApiTypes.STR,
            location=OpenApiParameter.QUERY,
            description='Campo a ser analisado (temperatura, umidade, precipitacao, velocidade_vento) - padrão: temperatura',
            default='temperatura'
        ),
        OpenApiParameter(
            name='periodo',
            type=OpenApiTypes.STR,
            location=OpenApiParameter.QUERY,
            description='Unidade do intervalo (dia, semana, mes) - padrão: semana',
            default='semana'
        ),
        OpenApiParameter(
            name='quantidade',
            ...
            location=OpenApiParameter.QUERY,
            description='Quantidade de unidades do intervalo (ex: 2 semanas) - padrão: 1',
            default=1
        )
    ],
    responses={
    ...
    examples=[
        ...
        OpenApiExample(
            ...
            value={
                ...
                'intervalo': '1 week',
                'dados': [
                    {'bucket': '2025-03-24T00:00:00-03:00', 'temperatura_avg': 25.3},
                    {'bucket': '2025-03-31T00:00:00-03:00', 'temperatura_avg': 26.1}
                ]
            },
            response_only=True,
            status_codes=['200']
